...
<div class="content-admin-main">
    ...
    <div class="aon-admin-heading" style="background-color:#2C6C5E; padding-top:10px; ">
        <h3 style="text-align: center;color:white; margin-top:10px;">  Our Patients List </h3>
    </div>  
    @foreach($patientsList as $data)
